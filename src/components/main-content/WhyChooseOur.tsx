...
export default function WhyChooseUs() {
    return (
            <section className="py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 bg-gradient-to-br from-gray-50 to-blue-50">
                <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-8 xl:gap-12 max-w-6xl mx-auto">
                        {reasons.map((reason, index) => (
                                <div key={reason.title} className="flex flex-col items-center text-center bg-white/80 backdrop-blur-sm rounded-xl p-6 sm:p-8 md:p-10 lg:p-8 xl:p-10 shadow-lg border border-white/20">
                                    <div className="relative mb-4 sm:mb-6">
                                        <div className="flex justify-center items-center p-4 sm:p-5 md:p-6 lg:p-5 xl:p-6 w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-24 lg:h-24 xl:w-28 xl:h-28 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 shadow-lg">
                                            {reason.icon}
                                        </div>
