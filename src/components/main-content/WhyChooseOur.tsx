                        ...
                        {reasons.map((reason, index) => (
                                <div key={reason.title} className="flex flex-col items-center text-center bg-white rounded-xl p-6 sm:p-8 md:p-10 lg:p-8 xl:p-10 shadow-lg border border-gray-100">
                                    <div className="relative mb-4 sm:mb-6">
                                        <div className="flex justify-center items-center p-4 sm:p-5 md:p-6 lg:p-5 xl:p-6 w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-24 lg:h-24 xl:w-28 xl:h-28 rounded-full bg-blue-100 text-blue-600 shadow-lg">
                                            {reason.icon}
                                        </div>
